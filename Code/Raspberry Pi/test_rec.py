...
output_video_file = "detection_output.mkv"  # Output video file name
output_fps = 30  # Frames per second for the output video
fourcc = cv2.VideoWriter_fourcc(*'XVID')  # Codec for the video file

# Create the VideoWriter object
out = cv2.VideoWriter(output_video_file, fourcc, output_fps, (frame_width, frame_height))
...
while True:
    ...
    if current_time - last_frame_time >= frame_interval:
        ...
        # Modified: Write the frame to the video file
        out.write(frame)
