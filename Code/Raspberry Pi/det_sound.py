...
# Use the TFLite runtime instead of TensorFlow
from tflite_runtime.interpreter import Interpreter

# Import the gTTS library for text-to-speech
import pyttsx3
...
while True:
    ...
    if len(faces) == 1:
        ...
        if current_time - last_frame_time >= frame_interval:
            ...
            play_sound("There are {} people detected {}".format(len(faces), last_predict_emotion))
