...
interpreter = Interpreter(model_path="/home/emprit/Documents/object_detection_azza/revisi/code_2/model_cnn.tflite")
interpreter.allocate_tensors()

face_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')
predictor_path = "/home/emprit/Documents/object_detection_azza/revisi/code_2/shape_predictor_68_face_landmarks.dat" 
...
def sound(emotion, count):
    text =  f"There are {count} people detected {emotion}."
    ...
    if len(faces) == 1:
        ...
        if current_time - last_frame_time >= frame_interval:
            ...
            for (x, y, w, h) in faces:
                ...
                print("Predicted class:", last_predict_emotion)
                
                count = sum([1 for face_class in name_classes if face_class == last_predict_emotion])
                print("Number of people detected", last_predict_emotion, ":", count)
                
                sound(last_predict_emotion, count)
